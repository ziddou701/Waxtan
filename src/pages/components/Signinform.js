...
const Signinform = () => {
    ...
    const [signInState , setSignInState] = useState(()=>{return true;});
    
    function SignInStateFalse(e) {
        e.preventDefault();
    ...
    return(
        <div>  
            ...
            <div className="rounded-3xl border-2 mx-auto p-3 w-5/6 relative top-16 drop-shadow-sm shadow-lg shadow-indigo-500/30 bg-slate-50/5 ">
                ...
                <div className="w-fit mx-auto grid grid-flow-row">
                    ...
                    <a href="" className="ml-2 text-sm font-black text-slate-500 underline" onClick={SignInStateFalse} >Sign Up</a>
                    </p>
                </div>
        ...
        : 
            ...
            <div>
                ...
                <div className="w-fit mx-auto grid grid-flow-row mt-8">
                    <p className="text-sm font-light text-slate-500"> Already have an acount?
                    <a className="ml-2 text-sm font-black text-slate-500 underline">Sign In</a>
                    </p>
                </div>
            </div>
        }
